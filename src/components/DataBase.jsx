...
const DataBase = ()=>{
    ...
    The app's loading may be slower due to free backend hosting. The backend server takes about a minute to start up when you first launch the app.
    
    We're working on a fix and will transition to a paid service for faster loading times.
    
    Bear with us as we make this important improvement.
